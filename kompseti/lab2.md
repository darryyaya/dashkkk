...
### Скриншот 1: Просмотр файлов в директории
![ls -r команда](img/img10.jpg)

На скриншотах продемонстрирована работа в терминале Linux:

### Скриншот 2: Просмотр SSH директории
![ls ~/.ssh команда](img/img11.jpg)
...
### Скриншот 3: Подключение к удалённому серверу
![ssh подключение](img/img12.jpg)
...
### Скриншот 4: Генерация и копирование SSH ключей
![ssh-keygen и ssh-copy-id](img/img13.jpg)
